...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      ZC: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      ZD: x0 => x0.data,
      a: Function.prototype.call.bind(BigInt.prototype.toString),
      aB: Function.prototype.call.bind(DataView.prototype.setInt32),
      aC: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      aD: () => globalThis,
      b: (exn) => {
      ...
      bC: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
