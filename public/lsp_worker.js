  ...
  var CompiledApp = class {
    ...
    async instantiate(additionalImports, { loadDeferredModules, loadDeferredId } = {}) {
      ...
      const dart2wasm = {
        ...
        DD: (ms, c) => setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
        DE: (x0) => x0.signal,
        E: (o) => o,
        EB: (o, p, v) => o[p] = v,
        ...
        RC: (ms, c) => setTimeout(() => dartInstance.exports.$invokeCallback(c), ms),
        ...
        SC: (s) => new Date(s * 1e3).getTimezoneOffset() * 60,
        SD: (x0) => x0.close(),
        T: (o) => o,
        ...
        ZC: () => 1e3 * performance.now(),
        ZD: (wasmFunction, f) => finalizeWrapper(f, function(x0) {
        ...
        bB: (x0) => new Array(x0),
        bC: (x0) => x0.deref(),
        bD: (wasmFunction, f) => finalizeWrapper(f, function(x0) {
          return wasmFunction(f, arguments.length, x0);
        }),
        ...
        e: (c) => queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
        ...
        gC: (wasmFunction, f) => finalizeWrapper(f, function(x0) {
          return wasmFunction(f, arguments.length, x0);
        }),
        gD: (x0, x1) => {
          x0.binaryType = x1;
        ...
        hB: (o) => o.buffer,
        hC: (wasmFunction, f) => finalizeWrapper(f, function(x0, x1) {
        ...
        iC: (p, s, f) => p.then(s, (e) => f(e, e === void 0)),
        iD: (o0, o1) => [o0, o1],
        ...
        pD: (wasmFunction, f) => finalizeWrapper(f, function(x0, x1, x2) {
...
//# sourceMappingURL=lsp_worker.js.map
